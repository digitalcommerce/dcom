...
{
    ui->setupUi(this);
    this->setStyleSheet("background-image: url(:/Background/res/images/nobg.png);" "background-color: white;" "background: white;");
    ...
    ui->sendButton->setIcon(QIcon());
     ...
     ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a dCom address"));
#endif
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    msgBox.setStyleSheet("background-image: url(:/Background/res/images/nobg.png);" "background-color: white;" "background: white;");
