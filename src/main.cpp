...
int64 nChainStartTime = 1401182444;
...
const string strMessageMagic = "Digital Commmerce Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in dCom
    bool fStrictPayToScriptHash = true; // Always active in dCom
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "dCom", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "NYTIMES - 27/05/2014 Data Suggests Missing Jet Used Up Fuel Before Crash";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1401182444;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3266672;
        ...
        assert(block.hashMerkleRoot == uint256("0xecb595bde7f579cd687cc86aa64e88484f5f2d21848e453258c94e6cd785f047"));
...
unsigned char pchMessageStart[4] = { 0xda, 0xa1, 0xbe, 0x2f };
